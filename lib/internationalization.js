...
var lang_en_US = {
		...
		howToSentimentPlot : {
			...
			headline : 'How does the sentiment plot work?',
			leadParagraph : 'Now, tweets related to Barack Obama are loaded into a <em>timeline</em>. \
...
var lang_pt_BR = {
		...
		howToSentimentPlot : {
			...
			leadParagraph : 'Após a seleção, os tuítes relacionados à Dilma aparecerão na <em>linha do tempo</em>. \
