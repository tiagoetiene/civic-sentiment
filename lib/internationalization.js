...
var lang_en_US = {
		...
		aboutLeadParagraph : 'Civic Sentiment was born during a San Francisco Reynolds Journalism Institute Hackaton. More info... links, media covergade, etc... still working on it',
		bio : {
...
var lang_pt_BR = {
		...
		goalStatement : 'Todos nós temos uma idéia do que as possoas falam a respeito de políticos, não? \
						  Aqui você pode visualizar o sentimento das pessoas dizem nas mídias sociais.',
		...
		cover1LeadParagraph : 'Digamos que você tem interesse em saber o que outras pessoas estão falando a respeito da Dilma Rousseff nas mídias sociais. \
						O primeiro passo é escolher Dilma Rousseff no menu:',
		...
		bio : {
			etiene : '<b>Tiago Etiene</b> nasceu em Ouro Preto, Minas Gerais. \
					...
					Ele tem interesse em <em>Big Data</em>, Análise de Dados, Visualização, Computação Gráfica, e mais.',
			kristen : ' <b>Kristen Nevious</b>... ',
			deepesh : '<b>Deepesh Kuruppath</b>...',
			lorraine : '<b>Lorraine Dechter</b>...',
			amy : '<b>Amy</b> ...'
