...
var lang_en_US = {
		...
		goalStatement : 'We all have a feeling for what people are saying about one politician or another. \
						Here you can visualize people\'s feelings towards politicians in real-time.',
		...
		cover1LeadParagraph : 'Let\'s say you would like to know what people say about Barack Obama on social media. \
						You start by selecting Barack Obama from the dropdown menu:',
		...
		cover2LeadParagraph : 'You can select a time frame by clicking one of the buttons:',
		cover2Content0 : 'By clicking at <div class="btn-group btn-md"  data-toggle="buttons"> \
		...
		aboutLeadParagraph : 'Civic Sentiment was born during a San Francisco Reynolds Journalism Institute Hackaton. \
								More info... links, media covergade, etc... still working on it',
		bio : {
...
var lang_pt_BR = {
		images : {
			curveExplanation : './resource/plot-example-pt.png'
		},
		...
		goalStatement : 'Todos nós temos uma idéia do que as pessoas falam a respeito de políticos. \
						  Aqui, você pode visualizar o sentimento das pessoas nas mídias sociais.',
		getStarted : 'Entendi. Vamos começar!',
		cover1Headline : 'Quero entender mais',
		cover1LeadParagraph : 'Digamos que você tem interesse em saber o que outras pessoas estão falando a respeito da \
						Dilma Rousseff nas mídias sociais. O primeiro passo é escolher Dilma Rousseff no menu:',
		...
		cover2Content0 : 'Clicando no botão <div class="btn-group btn-md"  data-toggle="buttons"> \
						<label class="btn btn-small btn-primary"> <input type="radio" name="options" checked> \
