...
var lang_en_US = {
		...
		howToSelectInterval : {
			...
			headline : 'How do I select a time frame?',
			...
			paragraph : 'By clicking at <div class="btn-group btn-md"  data-toggle="buttons"> \
						...
						past month </label></div>, you will see all tweets about Barack Obama for the past 30 days until this very moment.  \
						By clicking at <div class="btn-group btn-md"  data-toggle="buttons"> \
						<label class="btn btn-small btn-primary"> <input type="radio" name="options" checked> \
						past 5 min </label></div> you will see all tweets about Barack Obama in the past five minutes, including tweets that have been tweeted just now.',
		},
		home : 'Home',
		...
		users : 'users',
		online : 'online',
		teaserQuestion : 'What do people say about politicians?',
...
var lang_pt_BR = {
		...
		aboutLeadParagraph : 'Opinião do Eleitor nasceu durante uma Hackaton promovida pelo Reynolds Journalism Institute \
							em São Francisco, CA.',
		bio : {
...
configInternationalization = function() {
	...
	lang_en_US[ "options" ] = {}
	_.each( USStates_en, function(value, key) {
		lang_en_US[ "options" ][ key ] = value;
	});
